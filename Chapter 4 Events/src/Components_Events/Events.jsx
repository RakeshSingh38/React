import Button from '../Components_Events/PlayButton';
    ...
    return (
        <div className="p-5 text-white">
            ...
            <div className='flex gap-4'>
                ...
                <Button message='play-msg' onClick={(message)=>console.log(message)} >Play</Button>
                <Button message='play-msg' onClick={(message)=>alert(message)} >Pause</Button>
            </div>
        </div>
    );
};
